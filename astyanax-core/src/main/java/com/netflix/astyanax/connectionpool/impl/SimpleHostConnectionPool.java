...
public class SimpleHostConnectionPool<CL> implements HostConnectionPool<CL> {
    ...
    public String toString() {
        ...
        return "SimpleHostConnectionPool[" + "host=" + host + "-" + id + ",down=" + markedDownCount.get() + ",active=" + (!isShutdown()) + ",recon=" + isReconnecting() + ",connections(" +   "open=" + open +  ",idle=" + idle +  ",busy=" + (open - idle) +  ",closed=" + closedConnections.get() +  ",failed=" + failedOpenConnections.get() + ")" + ",borrow=" + borrowedCount.get() + ",return=" + returnedCount.get() + ",blocked=" + getBlockedThreadCount() + ",pending=" + getPendingConnectionCount() + ",score=" + TimeUnit.MILLISECONDS.convert((long)getScore(), TimeUnit.NANOSECONDS) + "]";
    }
