...
public final class ShardedDistributedMessageQueue implements MessageQueue {
    ...
    public static class Builder {
        ...
        private final String                          queueName = MessageQueueMetadata.DEFAULT_QUEUE_NAME;
        private final int                             metadataDeleteTTL = DEFAULT_METADATA_DELETE_TTL;
        private final Collection<MessageQueueHooks>   hooks = Lists.newArrayList();
